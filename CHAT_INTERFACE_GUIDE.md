...
The dashboard now includes a **chat-based interface** that allows you to control the dashboard using natural language queries instead of manually adjusting filters and settings.
...
2. Check the **"💬 Use Chat Interface"** checkbox
3. The chat assistant will appear below
...
- `"What about corporate whole life for ages 40-60?"`
...
**Query**: `"Show optimistic forecast for family term life policies for females aged 25-45"`
